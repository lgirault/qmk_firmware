...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUMS] = LAYOUT_ergodox(
    ...
    ___,     ___,    ___,        ___,     ___,
                                         ...
                                         ___, ___, ___,
    /* right hand */
         ___,     ___,     ___,   ___,   ___,     ___,     KC_CAPS,
         ___,     KC_PEQL, KC_P7, KC_P8, KC_P9,   KC_PMNS, KC_NLCK,
                  KC_PCMM, KC_P4, KC_P5, KC_P6,   KC_PPLS, KC_SLCK,
